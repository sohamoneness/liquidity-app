  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
    ...
    function srcAppLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginPage = /*#__PURE__*/function () {
        function LoginPage(authService, navCtrl, toastController, helper, router, platform, cdr, modalController, location, alertController, menuCtrl, authProvider) {
        ...
        _createClass(LoginPage, [{
          ...
          value: function submitLogin() {
            ...
            this.isSubmitted = true; //Validation checking
            ...
            if (this.usermail == '') {
              ...
              this.authProvider.userLogin(data).then(function (res) {
                if (res["status"] == '1') {
      ...
      LoginPage.propDecorators = {
        routerOutlets: [{
          ...
          args: [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonRouterOutlet"]]
        }]
      };
