(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["order-success-order-success-module"], {
    ...
    function srcAppOrderSuccessOrderSuccessRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var OrderSuccessPageRoutingModule = /*#__PURE__*/_createClass(function OrderSuccessPageRoutingModule() {
    ...
    function srcAppOrderSuccessOrderSuccessModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var OrderSuccessPageModule = /*#__PURE__*/_createClass(function OrderSuccessPageModule() {
    ...
    function srcAppOrderSuccessOrderSuccessPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var OrderSuccessPage = /*#__PURE__*/function () {
        function OrderSuccessPage(authService, navCtrl, userDetails, alertCtrl, helper, plt, _router) {
        ...
        _createClass(OrderSuccessPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.userDetails.fetchOrderHistroydetails(localStorage.getItem("orderrr_id")).then(function (res) {
              if (res["status"] == 1) {
                console.log('res', res);
                _this.OrderDetails = res["order"];
                _this.shopDetails = res["order"]["shop"];
      ...
      OrderSuccessPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
